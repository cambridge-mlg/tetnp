...
from ..networks.tetransformer import TEISTEncoder, TEPerceiverEncoder


class TEPTTNPEncoder(nn.Module):
    def __init__(
        self,
        transformer_encoder: Union[TEPerceiverEncoder, TEISTEncoder],
        y_encoder: nn.Module,
    ):
        super().__init__()
...
class TEPTTNP(ConditionalNeuralProcess):
    def __init__(
        self,
        encoder: TEPTTNPEncoder,
        decoder: TNPDecoder,
